...
def graph(m: Ltx, image: str, text: str, frames: int, seed: int, prefix: str) -> dict:
    ...
    return {
        ...
        "clip": {
            ...
            "inputs": {"clip_name": m.text_encoder, "type": "ltxv", "device": "default"},
        },
        ...
        "vlat": {
            ...
            "inputs": {"width": m.width // 2, "height": m.height // 2, "length": frames, "batch_size": 1},
        },
        "i2v1": {
        ...
        "alat": {
            ...
            "inputs": {"frames_number": frames, "frame_rate": fps, "batch_size": 1, "audio_vae": ["avae", 0]},
        },
        "av1": {
            "class_type": "LTXVConcatAVLatent",
            "inputs": {"video_latent": ["i2v1", 0], "audio_latent": ["alat", 0]},
        },
        "g1": {
        ...
        "ups": {
            ...
            "inputs": {"samples": ["sep1", 0], "upscale_model": ["up", 0], "vae": ["vae", 0]},
        },
        "i2v2": {
            "class_type": "LTXVImgToVideoInplace",
            "inputs": {
        ...
        "vid": {
            ...
            "inputs": {"images": ["dec", 0], "audio": ["adec", 0], "fps": float(fps)},
        },
        "save": {
            "class_type": "SaveVideo",
            "inputs": {"video": ["vid", 0], "filename_prefix": prefix, "format": "auto", "codec": "auto"},
        },
    }
