...
- [x] **Thumbnails** (`feat/thumbnails`). `/api/assets/{id}?w=` serves a picture as a JPEG 768 wide,
  ...
  120 MB as PNGs; the Board's slides now load 3.1 MB of them.
